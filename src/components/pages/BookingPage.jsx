...
const BookingPage = () => {
    ...
    const fetchServices = async () => {
        try {
            setLoading(true);
            const response = await fetch('https://localhost:7111/api/Service');
            if (!response.ok) {
    ...
    const fetchUserPets = async () => {
        try {
            setLoadingPets(true);
            const response = await fetch('https://localhost:7111/api/Pet/user-pets', {
                method: 'GET',
                credentials: 'include',
                headers: {
    ...
    const fetchPetTypes = async () => {
        try {
            ...
            const response = await fetch('https://localhost:7111/api/PetType/is-active');
    ...
    const fetchAvailableSlots = async () => {
        try {
            ...
            const response = await fetch(
                `https://localhost:7111/api/Booking/get-available-slot?selectedDay=${selectedDate}&durationInMinutes=${totalDuration}`
            );
    ...
    const handleAddPet = async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://localhost:7111/api/Pet', {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleSubmitBooking = async () => {
        ...
        try {
            ...
            const response = await fetch('https://localhost:7111/api/Booking', {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleConfirmBooking = async () => {
        try {
            ...
            const response = await fetch('https://localhost:7111/api/Booking/confirm-booking', {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                                ...
                                <div className="mb-3">
                                    ...
                                    <div className="d-flex flex-wrap gap-2">
                                        {selectedServices.map(service => (
                                            <span key={service.id} className="badge bg-primary fs-6 d-flex align-items-center gap-2">
                            ...
                            <div className="mb-3">
                                ...
                                />
                                {selectedServices.length === 0 && (
                                    <small className="text-muted">Vui lòng chọn dịch vụ trước</small>
                                )}
                            </div>
                                        ...
                                        <div className="row g-2">
                                            {availableSlots.map((slot, index) => (
                                                <div key={index} className="col-md-3 col-4">
                                                    <button
                                                        type="button"
                                                        className={`btn w-100 ${selectedSlot?.startAt === slot.startAt
                                                                ? 'btn-primary'
                                                                : 'btn-outline-primary'
                                                            }`}
                            ...
                            <div className="d-grid">
                                <button
                                    ...
                                    disabled={!selectedPet || selectedServices.length === 0 || !selectedSlot || submitting}
                                >
                                    {submitting ? (
                                        <>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        {loadingPetTypes ? (
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => setNewPet({ ...newPet, petTypeId: e.target.value })}
                                                required
                                            >
                ...
                <div className="modal show d-block" tabIndex="-1" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div className="alert alert-warning">
                                    <strong>⏰ Lưu ý:</strong> Hãy xác nhận lịch hẹn của bạn. Hệ thống sẽ chờ bạn xác nhận trong vòng 5 phút, nếu quá thời gian lịch hẹn sẽ bị hủy.
                                </div>
                                ...
                                <table className="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><strong className="text-primary">{bookingResult.bookingCode}</strong></td>
                                        </tr>
                                        <tr>
                                            <th>Thú cưng</th>
                                        ...
                                        <tr>
                                            <th>Tổng tiền</th>
                                            <td><strong className="text-danger fs-5">{bookingResult.totalPrice.toLocaleString('vi-VN')}đ</strong></td>
                                        </tr>
                                        {bookingResult.notes && (
                                            <tr>
                                                <th>Ghi chú</th>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-body text-center py-5">
                                ...
                                <h5 className="text-primary mb-4">{bookingResult.bookingCode}</h5>
