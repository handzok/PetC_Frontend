...
const ServiceManagement = () => {
    ...
    const fetchServices = async () => {
        try {
            ...
            const response = await fetch(`https://localhost:7111/api/ServiceManage/paginated?${params}`, {
                credentials: 'include'
            });
    ...
    const handleView = async (id) => {
        try {
            const response = await fetch(`https://localhost:7111/api/ServiceManage/${id}`, {
                credentials: 'include'
            });
    ...
    const handleEdit = (service) => {
        ...
        setImagePreview(service.imageUrl ? `https://localhost:7111${service.imageUrl}` : null);
        setShowModal(true);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (editingService) {
                response = await fetch(`https://localhost:7111/api/ServiceManage`, {
                    method: 'PUT',
                    headers: {
    ...
    const handleToggleActive = (id) => {
        showConfirm(
            ...
            async () => {
                try {
                    const response = await fetch(`https://localhost:7111/api/ServiceManage/soft-delete?id=${id}`, {
                        method: 'PATCH',
                        credentials: 'include'
                    });
                                        ...
                                        services.map((service) => (
                                            <tr key={service.id}>
                                                <td className="text-center">
                                                    {service.imageUrl ? (
                                                        <img
                                                            src={`https://localhost:7111${service.imageUrl}`}
                                                            alt={service.name}
                                                            className="rounded"
                            ...
                            <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-8">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-6">
                                                    <div className="mb-3">
                                                        <label className="form-label">Thời gian (phút) <span className="text-danger">*</span></label>
                                                        <input
                                                            type="number"
                                                            className="form-control"
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="submit" className="btn btn-primary" disabled={uploading}>
                                        <i className={`fas fa-${editingService ? 'save' : 'plus'} me-2`}></i>
                                ...
                                <div className="row">
                                    {viewingService.imageUrl && (
                                        <div className="col-md-4 mb-3">
                                            <img
                                                src={`https://localhost:7111${viewingService.imageUrl}`}
                                    ...
                                    <div className={viewingService.imageUrl ? 'col-md-8' : 'col-md-12'}>
                                        <table className="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    <th style={{ width: '40%' }}>ID:</th>
                                                    <td><code>{viewingService.id}</code></td>
                                                </tr>
                                                <tr>
                                                    <th>Tên dịch vụ:</th>
                                                    <td><strong className="fs-5">{viewingService.name}</strong></td>
                                                </tr>
                                                <tr>
                                                    <th>Mô tả:</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {viewingService.createAt
                                                            ? new Date(viewingService.createAt).toLocaleString('vi-VN')
                                                            : 'Chưa có thông tin'
                                                        }
                                                    </td>
                                                </tr>
